...
class _AddProductScreenState extends State<AddProductScreen> {
                      ...
                      BlocBuilder<ProductBloc, ProductState>(
                        ...
                        return CustomElevatedButton(
                            ...
                            onTap: () {
                              ...
                              print("Desc: ${productDescription.text}");
                              print("Price: ${productPrice.text}");
                              print("Qty: ${productQuantity.text}");
                              print("Category: $category");
                              List<File> file = [
                                File("/unimarket_app/assets/images/shoes_1.png")
                              ];
                              print(file);
                              _onSellProduct(
                                  context,
  ...
  void _onSellProduct(
    ...
    print("Sell Product in Add New Product");
    print(sellProductModel);
    BlocProvider.of<ProductBloc>(context).add(SellProduct(sellProductModel));
  }
}
